...
const Contacts = () => {
  return (
    <div>
      ...
      <p>Consectetur enim provident autem quasi commodi explicabo ipsam dolore suscipit. Id esse in harum voluptas obcaecati doloremque. Illum architecto consequuntur saepe facilis vero ducimus. Aperiam sunt eaque optio vero nesciunt!</p>
      <p>Lorem consectetur velit nostrum quidem alias neque! Esse unde autem incidunt laborum reprehenderit. Incidunt aliquid saepe doloremque quam quis! Ex facere ipsam in dignissimos veniam at illum accusantium? Accusantium neque.</p>
      <p>Adipisicing optio temporibus eos asperiores dolor itaque necessitatibus consequatur numquam! Ex tempora aspernatur cumque odit numquam hic aspernatur amet temporibus? Recusandae amet ratione maxime quibusdam consectetur hic ipsum sint? Rem.</p>
      <p>Adipisicing minus nobis commodi culpa earum? Dolorem necessitatibus ratione mollitia ipsa ad, excepturi ipsa officiis libero voluptates dolore error totam. Sunt quod porro ea omnis voluptatem! Repellat ratione eaque quis.</p>
    </div>
  )
